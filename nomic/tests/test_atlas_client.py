...
#         assert len(project.maps[0].get_topic_data()) > 0
#
#         q = np.random.random((3, 10))
#         assert len(project.maps[0].vector_search_topics(q, depth=1, k=3)['topics']) == 3
#
#         assert isinstance(project.maps[0].group_by_topic(topic_depth=1), dict)
#
#         project.delete()
#
#
