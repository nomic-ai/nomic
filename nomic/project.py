...
class AtlasProject(AtlasClass):
  ...
  def add_text(self, data: List[Dict], shard_size=1000, num_workers=10, replace_empty_string_values_with_string_null=True, pbar=None):
      '''
      ...
      **Returns:** True on success.
      '''
      project_id = self.id
      assert_valid_project_id(self.id)
